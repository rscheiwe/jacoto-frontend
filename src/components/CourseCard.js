    ...
    return (
      ...
      <Col md="4" style={{padding:'15px'}}>
...

        {
          ...
          <Link to={`/courses/${this.props.course.id}`}><img src={this.props.course.attributes.image} alt={this.props.course.id} className="img-fluid" alt="course0xcic1" style={{borderTopLeftRadius:'25px', borderBottomRightRadius:'25px'}} /></Link>
