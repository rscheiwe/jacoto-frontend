...
class UserCourseCard extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Col md="4" style={{padding:'15px'}}>
        ...
        {!this.props.course.image ? <img src={"https://mdbootstrap.com/img/Photos/Others/images/43.jpg"} className="img-fluid" style={{borderTopLeftRadius:'25px', borderBottomRightRadius:'25px'}} alt="dummy0xcic1"/> : <img src={this.props.course.image} alt={this.props.course.id} className="img-fluid" alt="course0xcic1" style={{borderTopLeftRadius:'25px', borderBottomRightRadius:'25px'}}/>}

        <Card.Content>
          <h5 style={{textAlign:'center', fontFamily:'Oswald', fontColor:'black'}}>{this.props.course.title}</h5>
